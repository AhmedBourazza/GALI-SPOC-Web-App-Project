    ...
    <section class="dashboard">
        ...
        <div class="dash-content">
                ...
                <div class="boxes">
                    ...
                    <div class="box box2">
                        ...
                        <span id="takingincidents" class="number"><?php  
                            $Rsql2 ="SELECT COUNT(*) AS total_rows FROM incident WHERE etatIncident='Taking';";
            ...
            <div class="activity">
                <div class="title">
                    <i class="ri-file-list-line"></i>
                    <span class="text">taking Encident</span>
                </div>
                ...
                <main class="table">
                    <section class="table__header">
                        ...
                        <div id="reloadBtn2"><i class="ri-restart-line"></i></div> 


                    </section>
                    <section class="table__body secondTable">
                        <table >
                            <thead>
                                <tr>
                                    <th> Id </th>
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        ...
        <div class="container py-5">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary solve-incident" data-incident-id="<?php echo $row['numIncident']; ?>">solved incident</button>
            </div>       
         </div>
    </div>
</div>
...
<script>
    $(document).ready(function() {
       /* function reloadTable() {
            $(".Mytbody").load("consultantSpaceTableReload2.php", function() {
